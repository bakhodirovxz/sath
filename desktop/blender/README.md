...
| Simulyatsiya | **Suv ombori/energiya → Blender timeline** (suv sathi keyframe, agregatlar rangi quvvat bo'yicha, Francis qo'pol zona sariq, tashlama rangi; model Pset_GES_* dan agregat/quvur/suv tashlagich), server katalogi (barcha turlar), forma pasport/modeldan, hisob (poll), natija, 3D suv sathi, xavfsizlik tekshiruvi (12 ssenariy) |
