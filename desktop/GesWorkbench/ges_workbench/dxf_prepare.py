...
oddiy chiziqlarga aylantiramiz:

  * INSERT (bloklar, atributlari bilan) → tarkibi (rekursiv, «EXPLODE» kabi)
  * DIMENSION / LEADER / MULTILEADER → AutoCAD chizgan chiziqlar + matn (o'lcham blokidan, qiymat o'zgarmaydi)
